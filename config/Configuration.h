...
#define STRING_CONFIG_H_AUTHOR "(majikd83, Octopus)" // Who made the changes.
...
#define PROBE_ENABLE_DISABLE
  ...
  #define PROBE_ENABLE_PIN PB6   // Override the default pin here
#endif
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN                PB0 // LED driving pin

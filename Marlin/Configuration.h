...
#define STRING_CONFIG_H_AUTHOR "(MAJIK, bf config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3D octopus"
...
>>>>>>> 06762db050399137796bbd192b94ed9da4a77e11
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -41, -1.8 }
...
<<<<<<< HEAD
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 45, 45 } // (mm) Left, Front, Right, Back insets
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 64              // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
